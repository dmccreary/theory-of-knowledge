# Learning Graph for Theory of Knowledge (TOK)
...
- Validates course description has sufficient depth for generating 275 concepts
...
- Foundational concepts: 1 entry point (Knowledge)
- Indegree distribution analysis
- Longest dependency chain: 14 steps
...
- Balanced categories (4.4% - 20.0% each)
