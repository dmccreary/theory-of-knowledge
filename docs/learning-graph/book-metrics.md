...
|---|---------|-------|--------|-------|
| 1 | Concepts | 275 | Required | Concepts from learning graph |
| 2 | Chapters | 16 | Required | Chapter directories with index.md |
| 3 | MicroSims | 69 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 14 | Optional | Graphic-novel narratives in docs/stories/ |
| 5 | Chapter Quizzes | 0 / 16 | Recommended | Chapters with a quiz.md (0 questions total) |
| 6 | Chapter References | 0 / 16 | Recommended | Chapters with references.md (0 references total) |
| 7 | Glossary Terms | 275 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 87 | Recommended | Questions in faq.md |
| 9 | Words | 232,359 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 68 | 68 | H4 headers starting with '#### Diagram:' |
| Equations | 1 | 0 | LaTeX expressions (inline and display) |
| Total Words | 232,359 | 84,081 | Words in markdown files |
| Links | 567 | 50 | Hyperlinks in markdown format |
| Equivalent Pages | 980 | 387 | Estimated pages (250 words/page + visuals) |
