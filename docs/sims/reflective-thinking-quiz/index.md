---
title: Reflective Thinking Quiz
description: Assess your own reflective thinking habits by responding to scenario-based questions and reviewing feedback on your reasoning patterns.
image: /sims/reflective-thinking-quiz/reflective-thinking-quiz.png
og:image: /sims/reflective-thinking-quiz/reflective-thinking-quiz.png
twitter:image: /sims/reflective-thinking-quiz/reflective-thinking-quiz.png
social:
   cards: false
quality_score: 0
---
...
[Run the Reflective Thinking Quiz MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/theory-of-knowledge/sims/reflective-thinking-quiz/main.html"
        height="602px"
        width="100%"
        scrolling="no"></iframe>
```
...
2. [Reflective Practice - Wikipedia](https://en.wikipedia.org/wiki/Reflective_practice)
3. [Metacognition - Wikipedia](https://en.wikipedia.org/wiki/Metacognition)
4. [List of Cognitive Biases - Wikipedia](https://en.wikipedia.org/wiki/List_of_cognitive_biases)
5. [Bloom's Taxonomy - Wikipedia](https://en.wikipedia.org/wiki/Bloom%27s_taxonomy)
